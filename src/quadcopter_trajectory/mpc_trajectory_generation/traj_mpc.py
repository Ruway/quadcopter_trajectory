...
class MPC_EULER(object):
    ...
    def __init__(self, model, dynamics, h = 0.05,
                 horizon=10, Q=None, P=None, R=None, E=None,PE=None,
        ...
        if terminal_constraint is not None:
            con_ineq.append(opt_var['x', self.Nt] - x_ref[(self.Nt-1)*12:12+(self.Nt-1)*12])
        ...
        #     'print_out': False,
        #     'max_iter' : 50,
        #     'qpsol_options' : {"max_iter": 10, "error_on_fail": False, 
        #                         "print_header":False, "print_iter":False},
        # }
